...
def load_checkpoint(model, mode, ckpt_path, logger, device):
	...
	return start_epoch, min_train_loss, min_val_loss, max_train_acc, max_val_acc, max_val_bleu, max_test_acc, max_gen_acc, best_epoch, voc1, voc2, voc3
